...
(function () {
  ...
  var state = {
    ...
    orders: [
      ...
      {
        id: 240, num: 240, status: 'route',
        name: 'Klára Veselá', phone: '+420 775 140 901',
        address: 'Hostim 22', city: 'Hostim', zone: 'Zóna 3',
        payment: 'online', placedAt: '13:59', etaMin: 22,
        note: 'Dovoz k brance, pes na zahradě.',
        items: [
      ...
      },
      {
        ...
        address: 'Tyršova 445', city: 'Beroun-Město', zone: 'Zóna 1',
        payment: 'cash', placedAt: '14:19', etaMin: 34,
        note: '',
        items: [
